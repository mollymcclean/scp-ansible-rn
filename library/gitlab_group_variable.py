...
short_description: This module manages a group variable in gitlab
...
options:
    ...
    variable_type:
        description:
            - The type of variable to create (either env_var (default) or file)
        required: false
...
class GitlabGroupVariable(object):
    def __init__(self):
        ...
        self.module_spec.update(
            ...
            variable_type=dict(type='str', required=False, default='env_var'),
    ...
    def get_variable(self, **kwargs):
        ...
        path = '/api/v4/groups/' + self.group_name + '/variables/' + self.variable_name
    ...
    def create_variable(self):
        # Internal variables that aren't set through the module input
        path = '/api/v4/groups/' + self.group_name + '/variables'
    ...
    def exec_module(self, **kwargs):
        ...
        elif result["value"] != self.variable_value or result["variable_type"] != self.variable_type:
